...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto py-10 pb-24 px-4 text-sm text-ink/80 leading-relaxed">
      ...
      <p className="text-xs text-ink/40 mb-8">Last updated: 9 August 2026 · Effective for Astryks (the "Service"), operated by the holder of Australian Business Number (ABN) 74 309 712 800, trading as Astryks ("Astryks", "we", "us").</p>
      ...
      <p className="mb-4">
        ...
        artificially inflating likes — see Section 8), or are inactive for an extended period.
      </p>

      <h2 className="font-display text-lg font-semibold mt-8 mb-2">4. Subscriptions &amp; billing</h2>
      <p className="mb-4">
        Astryks is offered as a recurring weekly subscription. The price shown to you depends on your
        billing country/currency (see our <Link href="/privacy" className="link-accent">Privacy Policy</Link> for
        how we determine that). Your subscription renews automatically each week until you cancel —
        you can cancel any time from your account settings (or, on iOS/Android, through your device's
        app store subscription settings), and cancellation takes effect at the end of the current
        billing period. We offer free refunds, no questions asked, unless a promotional/referral code
        was used on that subscription period. Prices may change with notice; continuing to use the
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">5. Content you post</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">6. Course content</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">7. The Creative Prize</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">8. Things you agree not to do</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">9. Termination</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">10. Disclaimers</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">11. Limitation of liability</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">12. Changes to these Terms</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">13. Governing law</h2>
      <p className="mb-4">
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">14. Contact</h2>
      <p className="mb-4">
