  ...
  return (
    <div className="max-w-2xl mx-auto py-10 pb-24 px-4 text-sm text-ink/80 leading-relaxed">
      ...
      <p className="mb-4">
        ...
        require a license, permit, or registration we do not hold. Astryks team members, our
        immediate family members, and anyone involved in judging or administering the prize are not
        eligible to win. Odds of winning depend on the number of eligible entries received in a given
        month and their relative like counts.
      </p>
      ...
      <h2 className="font-display text-lg font-semibold mt-8 mb-2">10. Questions</h2>
      <p className="mb-4">
